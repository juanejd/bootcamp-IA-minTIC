...
def get_reply(
    model, message: str, responses: Dict[str, List[str]], threshold: float = 0.45
) -> str:
...
def main():
    ...
    parser.add_argument(
        "--model",
        default="models/chatbot_model.pkl",
        help="Ruta al modelo .pkl entrenado",
    )
    parser.add_argument(
        "--responses",
        default="models/responses.json",
        help="Ruta al JSON de respuestas",
    )
    ...
    parser.add_argument(
        "--threshold", type=float, default=0.45, help="Umbral de confianza"
    )
